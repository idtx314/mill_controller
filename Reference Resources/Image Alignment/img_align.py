...
# This script was taken from https://www.learnopencv.com/image-alignment-feature-based-using-opencv-c-python/ and modified for experimentation.
...
if __name__ == '__main__':
  ...
  refFilename = "tags_r.jpg"
  print("Reading reference image : ", refFilename)
  imReference = cv2.imread(refFilename, cv2.IMREAD_COLOR)

  # Read image to be aligned
  imFilename = "mill_cam_1.jpg"
